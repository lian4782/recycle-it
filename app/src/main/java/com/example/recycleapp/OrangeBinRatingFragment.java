...
public class OrangeBinRatingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ViewGroup root = (ViewGroup) inflater.inflate(R.layout.fragment_orange_bin_rating, container, false);
        super.onCreate(savedInstanceState);

        UsersList = new ArrayList<UserForRating>();
        ArrayList<UserForRating> NewUsersList = new ArrayList<UserForRating>();

        recyclerView = root.findViewById(R.id.rwOrangBin);
